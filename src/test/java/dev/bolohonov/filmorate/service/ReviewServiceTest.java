...
import dev.bolohonov.filmorate.exceptions.*;
import dev.bolohonov.filmorate.model.Film;
import dev.bolohonov.filmorate.model.Mpa;
import dev.bolohonov.filmorate.model.Review;
...
class ReviewServiceTest {
    ...
    public void getReviewById() {
        ...
        assertAll(
                () -> Assertions.assertEquals(review, reviewService.findById(review.getId())),
    ...
    public void addLikeOrDeleteLikeReview() {
        ...
        assertAll(
                () -> {
                    ...
                    Assertions.assertEquals(reviewService.findById(review.getId()).getUseful(), 1);
                },
                () -> {
                ...
                () -> {
                    ...
                    Assertions.assertEquals(reviewService.findById(review.getId()).getUseful(), 0);
                }
        );
    }
